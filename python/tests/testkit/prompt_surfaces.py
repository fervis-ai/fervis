...
PROMPT_SURFACE_CONTRACTS = {
    ...
    "semantic_grounding": {
        "path": LOOKUP_ROOT / "grounding" / "semantic_prompt.py",
        "instruction_headings": (
            "Time resolution",
            "Identity meaning",
            "Resolver mechanics",
    ...
    "semantic_query_enrichment": {
        "path": LOOKUP_ROOT / "query_enrichment" / "semantic_prompt.py",
        "instruction_headings": (
            "Vocabulary scope",
    ...
    "semantic_read_eligibility": {
        "path": LOOKUP_ROOT / "read_eligibility" / "semantic_prompt.py",
        "instruction_headings": (
            "Identity selection",
            "Read assessment",
            "Output",
