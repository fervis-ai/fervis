        ...
        return (
            ...
            builder.instruction_block(
                ...
                (
                    ...
                    "DROP means the read contributes none of those. A read needed to resolve a requested reference, establish a relationship, or evaluate a qualification contributes to the complete answer even when it does not itself return the final counted rows or measure. Retain that read and the fields needed for that dependency. Drop context, audit, detail, or helper data only when it cannot affect any requested result or supplied reference.",
                    ...
                    "relevant_field_refs is the answer-changing computation support for this fact, including support for its supplied entity references. Include fields that establish row grain or identity, qualification, grouping, ordering, association, deduplication, a requested measure, or the definition of a referenced entity. Exclude fields that only decorate an otherwise fully determined result. Exact computations and field bindings are authored after relevance assessment.",
