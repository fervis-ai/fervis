...
_CONTRACT_TYPES = (
    ...
    operations.SqlColumnBinding,
    operations.SqlRelationInput,
    ...
    question_contract_model.QueryOperationDeclaration,
    question_contract_model.QuerySourceDeclaration,
    question_contract_model.QueryParameterDeclaration,
    question_contract_model.QueryQuestionContract,
    question_contract_model.QueryRequestedFact,
    question_contract_model.IntentFact,
    question_contract_model.IntentOutput,
    question_contract_model.IntentQuestionContract,
    question_contract_model.QueryRequestedOutput,
