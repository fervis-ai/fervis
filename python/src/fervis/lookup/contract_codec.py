...
from fervis.lookup.question_contract import semantic_model
...
_CONTRACT_TYPES = (
    ...
    semantic_model.Aggregate,
    semantic_model.AggregateFunction,
    semantic_model.AllResults,
    semantic_model.Arithmetic,
    semantic_model.AssociationTerm,
    semantic_model.BooleanComposition,
    semantic_model.BooleanCompositionOperator,
    semantic_model.Comparison,
    semantic_model.Coverage,
    semantic_model.FactLocalKind,
    semantic_model.FactLocalRef,
    semantic_model.FactTerm,
    semantic_model.FirstRankWithTies,
    semantic_model.InputDenotation,
    semantic_model.InputDenotationKind,
    semantic_model.InputTerm,
    semantic_model.InstanceInterpretation,
    semantic_model.NullCheck,
    semantic_model.Ordering,
    semantic_model.OrderingDirection,
    semantic_model.QuestionContract,
    semantic_model.Quantifier,
    semantic_model.Quantify,
    semantic_model.RequestedFact,
    semantic_model.RequestedOutput,
    semantic_model.SetTerm,
    semantic_model.Subject,
    semantic_model.TakeWithBoundaryTies,
    semantic_model.TemporalBucket,
    semantic_model.TemporalGrain,
