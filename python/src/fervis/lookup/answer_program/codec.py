...
_CONTRACT_TYPES = (
    ...
    operations.ComputeInputPopulationCoverage,
    ...
    relations.PopulationCoverageClaim,
    relations.PopulationCoverageRole,
    relations.PopulationChoiceControllerKind,
    relations.Relation,
    relations.RelationField,
    relations.RelationSource,
    relations.RelationSourcePopulationBinding,
    ...
    question_contract_model.MembershipTestRef,
    ...
    question_contract_model.GroupKeySourceKind,
