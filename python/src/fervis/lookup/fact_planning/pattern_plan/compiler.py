...
def compile_pattern_answer_plan(
    ...
    *,
    ...
    return AnswerPlan(
        ...
        values=tuple(
            item for compiled_item in compiled for item in compiled_item["values"]
        ),
        value_uses=tuple(
            item for compiled_item in compiled for item in compiled_item["value_uses"]
        ),
        relations=tuple(
...
_PATTERN_COMPILERS: dict[str, _PatternCompilerSpec] = {
    ...
    "ranked_aggregate": _PatternCompilerSpec(_compile_ranked_aggregate_answer),
    "computed_scalar": _PatternCompilerSpec(_compile_computed_scalar_answer),
