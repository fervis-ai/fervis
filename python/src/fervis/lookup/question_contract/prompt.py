        ...
        return (
            ...
            builder.instruction_block(
                ...
                (
                    ...
                    "Create question_inputs for concrete values supplied by the question or conversation resolution that a population predicate, result key, time constraint, or result limit consumes.",
            ...
            builder.instruction_block(
                ...
                (
                    ...
                    "Each question_input must have one primary contract role: population predicate operand, result key, time constraint, or result limit.",
            ...
            builder.instruction_block(
                ...
                (
                    ...
                    "question_input_use_refs may name only POPULATION_TESTS uses; GROUP_KEY and RESULT_LIMIT inputs are never membership-test operands.",
            ...
            builder.instruction_block(
                "Output",
                (
                    "Before returning a complete contract, verify that each copied question occurrence is declared once, every fact-local input appears once in question_input_uses, group-key inputs appear in no population test, and every EXPLICIT_USER_CONSTRAINT references its POPULATION_TESTS operands.",
