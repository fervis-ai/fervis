"""Frozen Fervis persistence schema snapshot for revision 0004."""
...
fervis_requested_fact = sa.Table(
    ...
    sa.Column("requested_fact_fingerprint", sa.String(64), nullable=False),
    ...
    sa.CheckConstraint(
        ...
        name="fervis_requested_fact_inputs_json_json_valid_ck",
    ),
)
sa.Index(
...
fervis_run_work_item = sa.Table(
    ...
    sa.Column("idempotency_authority_ref", sa.String(96), nullable=False),
...
sa.Index(
    ...
    fervis_run_work_item.c.idempotency_authority_ref,
    fervis_run_work_item.c.idempotency_scope,
