...
def _conversation_clause(
    ...
    current_value_text = _text(item.payload.get("current_value_text"))
    resolved_frame_text = _text(item.payload.get("resolved_frame_text"))
    resolved_clause_text = _text(item.payload.get("resolved_clause_text"))
    if not any(
        (
            current_clause_text,
            current_value_text,
